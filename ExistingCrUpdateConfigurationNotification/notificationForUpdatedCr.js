...
//const insertMailPayloadToSqs = (fnName, accountId, mem_size, vitalizeId) => {
    const insertNewCrMailPayloadToSqs = (fnName,accountId,mem_size,vitalizeId,contact,DownsizeDate) => {
        console.log("  ")
    ...
    return new Promise(async (resolve, reject) => {
        try {
            ...
            sqsPayLoad['Subject'] = `${fnName} CONFIGURATION UPDATE NOTIFICATION`;
            ...
            const mapObj = {
                ...
                targetDate: DownsizeDate,
                LAMBDA12 : fnName
            };

            emailTextPayload = emailTextPayload.replace(/\b(?:lambdaname|accountId|mem_size|vitalizeId|targetDate|LAMBDA12)\b/gi, matched => mapObj[matched]);
