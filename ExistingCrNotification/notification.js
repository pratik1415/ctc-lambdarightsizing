...
const sqs = new aws.SQS();
    ...
    const insertMailPayloadToSqs = (keys,TargetDate,attachmentFile) => {
       ...
       // try {
            ...
            sqsPayLoad['Subject'] = `LAMBDA MEMORY OVERSIZED NOTIFICATION`;
            ...
            emailTextPayload = emailTextPayload.replace(/\b(?:targetDate|contactxyz)\b/gi, matched => mapObj[matched]);
...
module.exports = { insertMailPayloadToSqs };